...
//! Covers major filming locations, national capitals, US state capitals, Canadian provincial
//! capitals, and significant cities worldwide.
...
const CITIES: &[(&[&str], &str)] = &[
    ...
    (
        &["montgomery"],
        "montgomery, alabama, united states, north america",
    ),
    (
    ...
    (
        &["los angeles", "l.a."],
        "los angeles, california, united states, north america, hollywood",
    ),
    (
        &["hollywood"],
        "hollywood, los angeles, california, united states, north america",
    ),
    (
        &["burbank"],
        "burbank, los angeles, california, united states, north america",
    ),
    (
        &["culver city"],
        "culver city, los angeles, california, united states, north america",
    ),
    (
        &["santa monica"],
        "santa monica, los angeles, california, united states, north america",
    ),
    (
        &["san francisco"],
    ...
    (
        &["tallahassee"],
        "tallahassee, florida, united states, north america",
    ),
    ...
    (
        ...
        "springfield, illinois, united states, north america",
    ),
    // Indiana
    (
        &["indianapolis"],
    ...
    // Kentucky
    (
        &["frankfort, ky", "frankfort, kentucky"],
        "frankfort, kentucky, united states, north america",
    ),
    (
        &["louisville"],
    ...
    (
        &["baton rouge"],
        "baton rouge, louisiana, united states, north america",
    ),
    (
        &["new orleans"],
    ...
    (
        &["shreveport"],
        "shreveport, louisiana, united states, north america",
    ),
    // Maine
    (
        &["augusta, me", "augusta, maine"],
        "augusta, maine, united states, north america",
    ),
    (
    ...
    (
        &["annapolis"],
        "annapolis, maryland, united states, north america",
    ),
    (
        &["baltimore"],
    ...
    (
        ...
        "st. paul, minnesota, united states, north america",
    ),
    (
        &["minneapolis"],
    ...
    (
        ...
        "jackson, mississippi, united states, north america",
    ),
    // Missouri
    (
        &["jefferson city"],
        "jefferson city, missouri, united states, north america",
    ),
    (
    ...
    (
        &["carson city"],
        "carson city, nevada, united states, north america",
    ),
    (
        &["las vegas"],
    ...
    (
        ...
        "concord, new hampshire, united states, north america",
    ),
    // New Jersey
    (
        &["trenton"],
        "trenton, new jersey, united states, north america",
    ),
    (
    ...
    (
        &["queens"],
        "queens, new york city, new york, united states, north america",
    ),
    (
        &["long island"],
    ...
    (
        &["bismarck"],
        "bismarck, north dakota, united states, north america",
    ),
    // Ohio
    (
    ...
    (
        ...
        "salem, oregon, united states, north america",
    ),
    (
    ...
    (
        &["harrisburg"],
        "harrisburg, pennsylvania, united states, north america",
    ),
    (
        &["philadelphia"],
    ...
    (
        &["park city"],
        "park city, utah, united states, north america, sundance",
    ),
    // Vermont
    (
        &["montpelier, vt", "montpelier, vermont"],
        "montpelier, vermont, united states, north america",
    ),
    (
    ...
    // Washington
    (
        &["olympia, wa", "olympia, washington"],
        "olympia, washington, united states, north america",
    ),
    (
        &["seattle"],
    ...
    (
        ...
        "charleston, west virginia, united states, north america",
    ),
    // Wisconsin
    (
    ...
    (
        &["yellowknife"],
        "yellowknife, northwest territories, canada, north america",
    ),
    // =========================================================================
    ...
    (
        &["manchester"],
        "manchester, england, united kingdom, uk, europe",
    ),
    (
        &["birmingham, uk", "birmingham, england"],
        "birmingham, england, united kingdom, uk, europe",
    ),
    (
        &["glasgow"],
        "glasgow, scotland, united kingdom, uk, europe",
    ),
    (
        &["edinburgh"],
        "edinburgh, scotland, united kingdom, uk, europe",
    ),
    (&["bristol"], "bristol, england, united kingdom, uk, europe"),
    (
        &["liverpool"],
        "liverpool, england, united kingdom, uk, europe",
    ),
    (&["leeds"], "leeds, england, united kingdom, uk, europe"),
    (
        &["belfast"],
        "belfast, northern ireland, united kingdom, uk, europe",
    ),
    (&["cardiff"], "cardiff, wales, united kingdom, uk, europe"),
    (
        &["pinewood"],
        "pinewood studios, buckinghamshire, england, united kingdom, uk, europe",
    ),
    (
        &["leavesden"],
        "leavesden studios, hertfordshire, england, united kingdom, uk, europe",
    ),
    (
        &["shepperton"],
        "shepperton studios, surrey, england, united kingdom, uk, europe",
    ),
    // =========================================================================
    ...
    (
        &["babelsberg"],
        "babelsberg, potsdam, brandenburg, germany, europe",
    ),
    ...
    (
        &["gothenburg", "göteborg"],
        "gothenburg, sweden, scandinavia, europe",
    ),
    (
        &["copenhagen", "københavn"],
        "copenhagen, denmark, scandinavia, europe",
    ),
    ...
    (
        &["gold coast"],
        "gold coast, queensland, australia, oceania",
    ),
    (&["hobart"], "hobart, tasmania, australia, oceania"),
    (
        &["darwin, au", "darwin, northern"],
    ...
    (
        &["mumbai", "bombay"],
        "mumbai, maharashtra, india, south asia, asia, bollywood",
    ),
    (
        &["delhi", "new delhi"],
        "new delhi, india, south asia, asia",
    ),
    (
        &["chennai", "madras"],
        "chennai, tamil nadu, india, south asia, asia, kollywood",
    ),
    (
        &["hyderabad"],
        "hyderabad, telangana, india, south asia, asia, tollywood",
    ),
    (
        &["bangalore", "bengaluru"],
        "bangalore, karnataka, india, south asia, asia",
    ),
    (
        &["kolkata", "calcutta"],
        "kolkata, west bengal, india, south asia, asia",
    ),
    (&["bangkok"], "bangkok, thailand, southeast asia, asia"),
    (&["singapore"], "singapore, southeast asia, asia"),
    (
        &["kuala lumpur"],
        "kuala lumpur, malaysia, southeast asia, asia",
    ),
    (&["manila"], "manila, philippines, southeast asia, asia"),
    (&["jakarta"], "jakarta, indonesia, southeast asia, asia"),
    (
        &["ho chi minh", "saigon"],
        "ho chi minh city, vietnam, southeast asia, asia",
    ),
    (&["hanoi"], "hanoi, vietnam, southeast asia, asia"),
    (
        &["phnom penh"],
        "phnom penh, cambodia, southeast asia, asia",
    ),
    // =========================================================================
    // MIDDLE EAST
    // =========================================================================
    ...
    (
        &["abu dhabi"],
        "abu dhabi, uae, united arab emirates, middle east",
    ),
    ...
    (
        &["marrakech", "marrakesh"],
        "marrakech, morocco, north africa, africa",
    ),
    ...
    (
        ...
        "mexico city, mexico, latin america, north america",
    ),
    (
        &["guadalajara"],
        "guadalajara, jalisco, mexico, latin america",
    ),
    (
        &["cancún", "cancun"],
        "cancún, quintana roo, mexico, latin america",
    ),
    (
        &["são paulo", "sao paulo"],
        "são paulo, brazil, latin america, south america",
    ),
    (
        &["rio de janeiro"],
    ...
    (
        &["bogotá", "bogota"],
        "bogotá, colombia, latin america, south america",
    ),
    (
        &["medellín", "medellin"],
        "medellín, colombia, latin america, south america",
    ),
    (&["lima"], "lima, peru, latin america, south america"),
    (
        &["santiago, chile", "santiago, cl"],
        "santiago, chile, latin america, south america",
    ),
    (
        &["havana", "la habana"],
        "havana, cuba, caribbean, latin america",
    ),
    (
        &["san juan, pr", "san juan, puerto"],
        "san juan, puerto rico, caribbean",
    ),
    (&["kingston, jamaica"], "kingston, jamaica, caribbean"),
    (
        &["panama city"],
        "panama city, panama, central america, latin america",
    ),
    (
        &["san josé, costa", "san jose, costa"],
        "san josé, costa rica, central america, latin america",
    ),
    (
        &["montevideo"],
    ...
    (
        &["caracas"],
        "caracas, venezuela, latin america, south america",
    ),
    // =========================================================================
    // PACIFIC ISLANDS
    // =========================================================================
