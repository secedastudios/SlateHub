...
fn test_person_embedding_text() {
    let text = build_person_embedding_text(
        ...
        &["acting".to_string(), "singing".to_string()],
        Some("Los Angeles, CA"),
        Some((25, 35)),
        Some("male"),
        &["caucasian".to_string()],
        ...
        &["SAG-AFTRA".to_string()],
        &["Broadway musical theater".to_string()],
        Some((30, 40)),
        &["latino".to_string(), "mediterranean".to_string()],
        Some("american"),
    );
...
fn test_location_embedding_text() {
    let text = build_location_embedding_text(
        ...
        "CA",
        "USA",
        &["natural light".to_string(), "modern furniture".to_string()],
